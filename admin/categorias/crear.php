        ...
        <div class="panel" style="max-width:700px;">
            ...
            <form method="POST" class="card-form">
                ...
                <div class="card-header">
                    ...
                    <p>Ingrese la información básica para la nueva categoría.</p>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="campo">
                        ...
                        <input type="text" name="nombre" placeholder="Ej. Saludos, Números, Colores" required>
                    </div>

                    <div class="campo">
                        <label>Descripción</label>
                        <textarea name="descripcion" placeholder="Breve descripción de las lecciones que pertenecen a esta categoría..."></textarea>
                        <p class="ayuda">La descripción ayuda a los usuarios a entender qué encontrarán en esta categoría.</p>
                    </div>
